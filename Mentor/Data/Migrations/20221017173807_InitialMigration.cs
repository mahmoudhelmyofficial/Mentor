        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IfSubscribe = table.Column<bool>(type: "bit", nullable: false),
                    CoursePoster = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApplyRequests_Users_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    JobImage = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    JobPublisherId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CategoryId = table.Column<int>(type: "int", nullable: false),
                    DateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EmployerProfileId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Jobs_Users_JobPublisherId",
                        column: x => x.JobPublisherId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommentWriter = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LessonFileUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CourseLessons_CourseUnits_CourseUnitId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplyRequests_EmployeeId",
                table: "ApplyRequests",
                column: "EmployeeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseLessons_CourseUnitId",
                table: "CourseLessons",
                column: "CourseUnitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Jobs_JobPublisherId",
                table: "Jobs",
                column: "JobPublisherId");
